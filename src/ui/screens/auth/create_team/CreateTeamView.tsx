    ...
    >
      ...
      >
            ...
            >
              <AppFormField
                ...
                fieldInputProps={{
                  ...
                  returnKeyType: 'next',
                  placeholder: STRINGS.create_team.enter_team_name,
              ...
              <AppFormField
                ...
                fieldInputProps={{
                  ...
                  keyboardType: 'default',
                  returnKeyType: 'next',
                  placeholder: STRINGS.create_team.enter_full_name,
                  placeholderTextColor: COLORS.theme?.interface['300'],
                  style: [styles.fieldInputStyle],
                  viewStyle: [styles.textFieldStyle],
                }}
              ...
              <AppFormField
                ...
                fieldInputProps={{
                  ...
                  returnKeyType: 'next',
                  placeholder: STRINGS.create_team.enter_your_email,
                  autoCapitalize: 'none',
                  placeholderTextColor: COLORS.theme?.interface['300'],
                  style: [styles.fieldInputStyle],
                  viewStyle: [styles.textFieldStyle],
              ...
              <AppFormField
                ...
                fieldInputProps={{
                  ...
                  keyboardType: 'default',
                  returnKeyType: 'done',
                  placeholder: STRINGS.create_team.create_password,
                  autoCapitalize: 'none',
                  placeholderTextColor: COLORS.theme?.interface['300'],
                  style: [styles.fieldInputStyle],
                  viewStyle: [styles.textFieldStyle],
        ...
        <Text style={styles.privacyTextStyle}>
          ...
          <Text style={styles.privacyTextStyle}>{STRINGS.create_team.and}</Text>
          <Text
            style={styles.link}
            onPress={() => {
