...
const ItemAttendance: FC<Props> = ({ item, index, lastIndex }) => {
  ...
  const renderImage = () => {
    return (
      <View>
        {item.punch_out_id
          ? item.location_flag_punch_out === 1 && renderLocationImage()
            ...
            {item?.type === ELeaveType.ATTENDANCE ? (
              <>
                <View style={styles.iconContainer}>
                  ...
                  />
                  <AppLabel style={styles.times} text={item?.in_time} />
                </View>
                <View style={styles.iconContainer}>
                  <Image
                    ...
                    style={styles.iconsStyle}
                  />
                  <AppLabel style={styles.times} text={item?.out_time} />
                </View>
                <View style={styles.iconContainer}>
                  <Image
                    ...
                    style={styles.iconsStyle}
                  />
                  <AppLabel style={styles.times} text={item?.working_hours} />
                </View>
              </>
            ) : item?.leave?.name ? (
              <AppLabel
              ...
              <AppLabel text={''} style={{ fontSize: FONT_SIZE._3xs }} />
            )}
          </View>
